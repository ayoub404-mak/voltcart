                                ...
                                <div className="flex flex-col justify-center text-sm">
                                    ...
                                    <div>
                                        {ratings.find(rating => order.id === rating.orderId && item.product.id === rating.productId)
                                            ...
                                            : <button onClick={() => setRatingModal({ orderId: order.id, productId: item.product.id })} className={`text-indigo-600 hover:bg-indigo-50 transition ${order.status !== "DELIVERED" && 'hidden'}`}>Rate Product</button>
                                        }</div>
