    ...
    return (
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-indigo-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-indigo-300 text-indigo-600 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-indigo-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free Shipping on Orders Above $50! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                        <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-slate-600 to-[#ba74ff] bg-clip-text text-transparent max-w-xs  sm:max-w-md'>
                    ...
                    <Image className='sm:absolute bottom-0 right-0 md:right-10 w-full sm:max-w-md' src={assets.hero_model_img} alt="" />
                </div>
