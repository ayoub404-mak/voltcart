...
const ProductCard = ({ product }) => {
    ...
    // ✅ FIX: Calculate the average rating safely. 
    // If the product has no ratings, it defaults to 0 instead of crashing or becoming NaN.
    const ratingsArray = product.rating || [];
    const rating = ratingsArray.length > 0 
        ? Math.round(ratingsArray.reduce((acc, curr) => acc + curr.rating, 0) / ratingsArray.length) 
        : 0;
